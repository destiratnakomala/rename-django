...
SECRET_KEY = 'django-insecure--mqo70n$ni70pt9)4mt0!c(8wsfta1ak6^htts)lpk3w^nr_8l'
...
STATIC_URL = '/static/'  # Make sure this has the leading slash
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # This is where collectstatic will store static files
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'core/static'),  # Adjust this if your static files are in a different directory
]
